...
class Tour extends Component {
  ...
  render() {
    if(this.props.route === 'embrenhe-se') {
      return (
        <Content>
          <ListWithPhoto title='Olaaa' icon='utensils' text='ai meu deus' img={imgTest} colImg={6} />
          <ListWithPhoto title='Olaaa' icon='language' subTitle='Lalalala' text='ai meu deus' img={imgTest} />
    ...
    } else if(this.props.route === 'entranhe-se') {
      return (
        <div>IT FREAKING WORKS!!!</div>
      )
    } else {
      return (
        <div>QUE QUE TACONTESENO</div>
      )
    }
  }
}
