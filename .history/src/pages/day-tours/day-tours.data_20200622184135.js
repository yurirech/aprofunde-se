...
export const cards1 = [{
  ...
  description: ``Conheça a charmosa cidade de Haarlem, viste o museu local e vá de bicicleta à praia curtir o por do sol, tudo acompanhado de um guia turístico.
Duração: 8 horas``,
