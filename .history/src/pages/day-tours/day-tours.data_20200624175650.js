...
export const cardsRight = [{
  image: utrech,
  title: 'Haarlem & Praia de bicicleta',
  description: <small>Image by Pieter van de Sande
Utrecht & Castelo
Conheça um dos maiores castelos da Holanda, o De Haar, famoso por séculos e ponto de encontro de celebridades do século passado. Depois passeie pelas ruas de Utrecht e se apaixone. <br/> Duração: 8 horas</small>,
},
{
  image: delft,
  title: '',
