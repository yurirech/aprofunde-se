...
export const header = {
  ...
  mainText: <span> Está com viagem marcada pra Holanda mas não sabe o que fazer fora passear em Amsterdam? 
  ...
  ou customize o seu próprio day tour e cuidaremos de todos os detalhes. Para mais idéias cheque Inspire-se e nosso Instagram.</span>
}
