...
import {FlexContainer} from '../../_varia';
...
const DayTours = () => (
      <Content>
        ...
        {
          cards.map(card => (
            <CustomCardWithBackground backgroundImage={card.image} description={card.description} route={card.route} buttonBackgroungColor='${color.}' />
          ))
        }
        </FlexContainer>
