...
import {homeTours, toursCard, ourSevices.embrenhaSe, packageDetails} from "./packages.data";
...
class Packages extends Component {
  ...
  render() {
    ...
    if(location.pathname === '/packages') {
      ...
      return <Package packageDetails={packageDetails.embrenhaSe} ourServices={ourSevices.embrenhaSe} itineraryTables={ourSevicesEmbrenhaSe} />
