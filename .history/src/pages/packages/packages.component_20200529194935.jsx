...
import {homeTours, toursCard, ourSevices, packageDetails} from "./packages.data";
...
class Packages extends Component {
  ...
  render() {
    ...
    if(location.pathname === '/packages') {
      ...
      return <Package packageDetails={packageDetails.embrenhaSe} ourServices={ourSevices.embrenhaSe} itineraryTables={ourSevices.embrenhaSe} />
