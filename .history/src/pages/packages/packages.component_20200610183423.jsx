...
class Packages extends Component {
  ...
  render() {
    ...
    if(location.pathname === '/packages') {
      ...
      return <Package packageDetails={packageDetails.embrenhaSe} ourServices={ourSevices.embrenhaSe} 
      itineraryTables={itineraryTables.embrenhaSe} />
    
    } else if (location.pathname === '/packages/entranhe-se') {
      return <Package packageDetails={packageDetails.entranheSe} ourServices={ourSevices.entranheSe} 
      itineraryTables={itineraryTables.entranheSe} />
    
    } else {
      return <Package packageDetails={packageDetails.entregueSe} ourServices={ourSevices.entregueSe} 
