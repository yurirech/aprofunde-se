...
export const packageDetails = {
  ...
  entranheSe: {
    ...
    description: `Uma semana é um tempo perfeito pra conhecer a fundo essa cultura maravilhosa. Com o Aprofunde-se é possível visitar as principais cidades do país assim como lugares menos conhecidos, mas ainda sim muito especiais, 
    como: Amsterdam, Giethoorn, Zaanse Schans, Gouda, Otterlo, Amersfoort, Utrecht, Rotterdam, Den Haag e Haarlem.`
  },
  entregueSe: {
    title: 'lalala',
    subtitle: 'lelele',
