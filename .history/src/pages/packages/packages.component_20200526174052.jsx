...
import CentralizedSection from "../../components/SharedComponents/centrilized-section/CentralizedSection";
...
class Packages extends Component {
  ...
  render() {
    ...
    } else if(this.props.location.pathname === '/packages/embrenhe-se') {
