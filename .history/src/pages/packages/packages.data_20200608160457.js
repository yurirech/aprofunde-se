...
export const homeTours = {
  title: 'Tours',
  mainText: `Nosso amplo conhecimento sobre o mundo das viagens e sobre a Holanda nos permite criar experiências personalizadas para os nossos clientes de acordo com seus gostos pessoais e solicitações. Independente do que for, nós fazemos acontecer. 
Os Pacotes são viagens de 6, 8 ou 10 dias com um itinerário incrível planejado especialmente pra você, visando o maior aproveitamento da sua viagem para que você poça conhecer o máximo da Holanda possível e se emergir totalmente na cultura sem nenhuma preocupação.
Nos envie uma mensagem dizendo o seu pacote preferido, e que tipo de viajante és, para começarmos a planejar logo a sua próxima viagem. Para mais idéias cheque Inspire-se e nosso Instagram.`,
