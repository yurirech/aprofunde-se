...
export const itineraryTables = {
  ...
  },
  {
    ...
    description: `Café da manha no hotel em Amsterdam. Buscamos os clientes no hotel as 9:00 e vamos para Giethoorn 
  ...
  },
  {
    ...
    description: `Café da manha no hotel em Amersfoort. Trem para Utrecht e uma atividade.
  ...
  },
  {
    ...
    description: `Café da manha no hotel em Rotterdam. Tour pela cidade das 10:00 as 11:30. 
  ...
  },
  {
    ...
    description: `Café da manha no hotel em Den Haag. Ida para Haarlem de carro, passeio no campo de Tulipas. 
    A noite jantar especial com show ao vivo.` 
  },
  {
    day: `6o dia`,
    city: `Amsterdam`,
    description: `Café da manha hotel Amsterdam. Translado hotel - aeroporto.` 
  }
],
  entranheSe: [
  {
  ...
  },
  {
    ...
    description: `Café da manha no hotel em Amsterdam. Buscamos os clientes no hotel as 9:00 e vamos visitar os moinhos. 
    De la vamos visitar a vila dos pescdores de Volendam.No final da tarde voltamos para o Hotel em Amsterdam.` 
  },
  {
    day: `3o dia`,
    city: <span>Giethoorn <br/> Otterlo <br/> Amersfoort</span>,
    description: `Café da manha no hotel em Amsterdam
  ...
  },
  {
    ...
    description: `Café da manha no Hotel em Amersfoort. Por volta das 11 iremos conhecer Gouda e depois disso iremos ao 
    Castelo de Haar em Utrecht. Estadia em Utrecht.` 
  },
  {
    day: `5o dia`,
    city: <span>Utrecht <br/> Rotterdam </span>,
    description: `Café da manha no hotel em Utrecht.
    No almoço pegamos trem para Rotterdam onde deixaremos as malas no hotel e sairemos para almoçar e passear.` 
  },
  {
    day: `6o dia`,
    city: <span>  Rotterdam <br/> Den Haag </span>,
    description: `Café da manha no hotel em Rotterdam. Tour pela cidade das 10:00 as 11:3. 
  ...
  },
  {
    ...
    description: `Café da manha em Utrecht.
  ...
  },
  {
    ...
    description: `Café da Manha em Antwerp. Voltaremos para a Holanda, fazendo uma breve parada para Almoço em 
  ...
  },
  {
    ...
    description: `Café da manha no hotel em Haarlem. Ida para a praia de bicicleta. A noite jantar especial com show ao vivo.` 
  },
  {
    day: `10o dia`,
    city: 'Amsterdam',
