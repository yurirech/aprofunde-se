...
export const packageDetails = {
  ...
  entregueSe: {
    ...
    description: `Nesse tour você vai sair da Holanda como um expert sobre o país. Com o Aprofunde-se você vai viajar de norte a sul do país, com direito a uma noite na Bélgica até! Cidades a serem conhecidas: Amsterdam, Giethoorn, Zaanse Schans, Gouda, Otterlo, Amersfoort, Utrecht, Rotterdam, Den Haag, Haarlem, Maastricht, Middelburg,Volendam e Antwerp.`
  }
}
