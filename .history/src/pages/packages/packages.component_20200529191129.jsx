...
import {homeTours, toursCard, test, packageDetails} from "./packages.data";
...
class Packages extends Component {
  ...
  render() {
    ...
    if(location.pathname === '/packages') {
      ...
      return <Package packageDetails={packageDetails} ourServicesCard={test} itineraryTable={itineraryTable} />
    } else {
