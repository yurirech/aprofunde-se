...
export const packageDetails = {
  ...
  entranheSe: {
    ...
    mas ainda sim muito especiais, como: Amsterdam, Giethoorn, Zaanse Schans, Gouda, Otterlo, Amersfoort, Utrecht, Rotterdam, Den Haag e Haarlem.`
  },
  entregueSe: {
    title: 'Entregue-se',
    subtitle: '10 dias 9 noites',
    description: `Nesse tour você vai sair da Holanda como um expert sobre o país. Com o Aprofunde-se você vai viajar de norte a sul do país, com direito a uma noite na Bélgica até! Cidades a serem conhecidas: Amsterdam, Giethoorn, 
    Zaanse Schans, Gouda, Otterlo, Amersfoort, Utrecht, Rotterdam, Den Haag, Haarlem, Maastricht, Middelburg,Volendam e Antwerp.`
  }
}
